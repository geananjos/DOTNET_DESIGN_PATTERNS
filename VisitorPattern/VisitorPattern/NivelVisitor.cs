...
namespace VisitorPattern
{
    public class NivelVisitor : IVisitor
    {
        public void Identificar(Chefao chefao)
        {
            ...
            {
                case "Boss 1":
                    Console.WriteLine("O chefão {0} é {1}% dificil e tem {2} pontos de vida", chefao.NomeChefao, 25, chefao.PontoVida);
                    break;
                case "Boss 2":
                    Console.WriteLine("O chefão {0} é {1}% dificil e tem {2} pontos de vida", chefao.NomeChefao, 50, chefao.PontoVida);
                    break;
            }
        }
